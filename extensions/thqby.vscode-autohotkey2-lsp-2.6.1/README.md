**English** | [中文](https://github.com/thqby/vscode-autohotkey2-lsp/blob/HEAD/README.zh-CN.md)
...
If you wish to donate, donations can be sent here: [alipay](https://qr.alipay.com/fkx19566u7ctegoppmu5i13) or [alipay qrcode](https://github.com/thqby/vscode-autohotkey2-lsp/blob/HEAD/pic/alipay.jpg) or [paypal](https://paypal.me/thqby)
...
![rename](https://github.com/thqby/vscode-autohotkey2-lsp/raw/HEAD/pic/rename.gif)

### Diagnostics

Simple syntax error diagnosis.

![diagnostics](https://github.com/thqby/vscode-autohotkey2-lsp/raw/HEAD/pic/diagnostics2.png)
...
![snippet1](https://github.com/thqby/vscode-autohotkey2-lsp/raw/HEAD/pic/snippet.png)

![snippet2](https://github.com/thqby/vscode-autohotkey2-lsp/raw/HEAD/pic/snippet.gif)

### Signature

Support for intelligent prompts for function parameters.

![signature](https://github.com/thqby/vscode-autohotkey2-lsp/raw/HEAD/pic/signature.gif)
...
![semanticTokens](https://github.com/thqby/vscode-autohotkey2-lsp/raw/HEAD/pic/semanticTokens.png)

### Tags

usage: Add `;;`(default) or `; TODO ` to the comment code Tags.

![codeSymbole](https://github.com/thqby/vscode-autohotkey2-lsp/raw/HEAD/pic/codeSymbol.png)

### Document Color

Compute and resolve colors inside a document to provide color picker in editor.

![documentcolor](https://github.com/thqby/vscode-autohotkey2-lsp/raw/HEAD/pic/documentcolor.png)
...
![hover](https://github.com/thqby/vscode-autohotkey2-lsp/raw/HEAD/pic/hover.png)
...
![gotoDefinition](https://github.com/thqby/vscode-autohotkey2-lsp/raw/HEAD/pic/gotoDefinition.png)
...
![codeFormat](https://github.com/thqby/vscode-autohotkey2-lsp/raw/HEAD/pic/codeFormat.gif)
